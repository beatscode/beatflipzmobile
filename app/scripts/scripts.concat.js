    ...
    .controller('RegisterCtrl', ['$rootScope', '$scope', 'environment', '$location', '$http',
        ...
        function($rootScope, $scope, environment, $location, $http) {
            ...
            $scope.register = function() {
                ...
                var postString = "alias=" + $scope.registerModel.email + "&email=" + $scope.registerModel.email + "&password=" + $scope.registerModel.password + "&type=" + $scope.registerModel
                    .type;
...
.service('tagService', ['$q', '$http', 'environment',
    ...
    .service('environment', [
        ...
        function() {
            var test = false;
            return {
                'api': (test) ? 'http://beatflipz.dev/app' : 'https://www.beatflipz.com/app',
                /**
